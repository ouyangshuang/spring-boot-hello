...
public class SampleProfileApplicationTests {
	...
	public void testDefaultProfile() throws Exception {
		HelloProfileApplication.main(new String[0]);
		String output = this.outputCapture.toString();
		assertTrue("Wrong output: " + output, output.contains("Hello ouyang"));
	}
	...
	public void testGenericProfile() throws Exception {
        ...
        HelloProfileApplication.main(new String[0]);
		String output = this.outputCapture.toString();
		assertTrue("Wrong output: " + output, output.contains("shuang ouyang"));
	}

	@Test
	public void testGoodbyeProfileFromCommandline() throws Exception {
        HelloProfileApplication
				.main(new String[] { "--spring.profiles.active=dev" });
		String output = this.outputCapture.toString();
		assertTrue("Wrong output: " + output, output.contains("Goodbye Everyone"));
	}
